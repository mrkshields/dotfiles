...
complete -c cast -n "__fish_seen_subcommand_from etherscan-source" -s c -l chain -r -f -a "{mainnet	,ropsten	,rinkeby	,goerli	,kovan	,xdai	,polygon	,polygon-mumbai	,avalanche	,avalanche-fuji	,sepolia	,moonbeam	,moonbeam-dev	,moonriver	,optimism	,optimism-kovan	,fantom	,fantom-testnet	,arbitrum	,arbitrum-testnet	,bsc	,bsc-testnet	,cronos	}"
...
complete -c cast -n "__fish_seen_subcommand_from interface" -s c -l chain -r -f -a "{mainnet	,ropsten	,rinkeby	,goerli	,kovan	,xdai	,polygon	,polygon-mumbai	,avalanche	,avalanche-fuji	,sepolia	,moonbeam	,moonbeam-dev	,moonriver	,optimism	,optimism-kovan	,fantom	,fantom-testnet	,arbitrum	,arbitrum-testnet	,bsc	,bsc-testnet	,cronos	}"
